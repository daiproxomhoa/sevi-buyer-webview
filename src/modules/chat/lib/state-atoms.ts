...
export const CurrentChannelMessagesAtom = atom(
  ...
  (get, set, value) => set(MessagesAtom, Object.assign({}, get(MessagesAtom), { [get(CurrentChannelAtom)]: value })),
);

export const CurrentChannelPaginationAtom = atom(
  (get) => get(PaginationAtom)[get(CurrentChannelAtom)] || false,
  (get, set, value) =>
    set(PaginationAtom, Object.assign({}, get(PaginationAtom), { [get(CurrentChannelAtom)]: value })),
);

export const CurrentChannelTypingIndicatorAtom = atom(
  (get) => get(TypingIndicatorAtom)[get(CurrentChannelAtom)] || {},
  (get, set, value) =>
    set(TypingIndicatorAtom, Object.assign({}, get(TypingIndicatorAtom), { [get(CurrentChannelAtom)]: value })),
);
