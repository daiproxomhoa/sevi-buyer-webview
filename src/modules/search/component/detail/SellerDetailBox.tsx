    ...
    <>
      ...
      >
        ...
        <Box style={{ padding: '12px 0 0' }}>
          <WhiteIconButton onClick={onClose} style={{ position: 'absolute' }}>
          ...
          >
            <Avatar
              src={loading || !info?.avatar ? undefined : API_PATHS.renderSellerAvatar(info?.id, info?.avatar)}
              style={{
                height: 155,
                width: 155,
                borderRadius: 16,
        ...
        <HeaderTab
          ...
          tabIndex={tabIndex}
          tabList={[intl.formatMessage({ id: 'search.rating' }), intl.formatMessage({ id: 'search.info' })]}
      ...
      >
        <Button disabled={loading} variant="contained" color="primary" fullWidth size="large" onClick={onSendRequest}>
