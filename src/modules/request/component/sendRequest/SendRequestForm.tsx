...
import { Button, FormHelperText, MenuItem, TextField, Typography } from '@material-ui/core';
...
const SendRequestForm = (props: Props) => {
  ...
  const { handleSubmit, control, getValues, setValue } = useForm<ICreateRequestForm>({
    reValidateMode: 'onChange',
    mode: 'onChange',
    defaultValues: {
      date: '',
      time: '',
      desc: intl.formatMessage({ id: 'request.iWantFind' }, { text: description }),
